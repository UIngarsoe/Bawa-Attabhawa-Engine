## ဆနွင်းမကင်း ဖုတ်သော လောကပါလနှင့် စစ်သင်္ဘော ၇ စီး၏ ပရိယာယ်- သော်တာဆွေ-နန္ဒာသိန်းဇံ Algorithm Algorithm Fusion
...
၃။ မဆိုင်သည်များကို ယုတ္တိရှိရှိ ပေါင်းစပ်တတ်ခြင်း (Synthesizing Engine)
